...
pipeline {
   ...
   parameters {
    ...
    string(name: 'max_workers', defaultValue : '5', description: "k8s maximum number of worker instances that can be scaled.")
    string(name: 'admin_users', defaultValue : 'sfd2021_demo', description: "Comma delimited list of IAM users to add to the aws-auth config map.")
    string(name: 'credential', defaultValue : 'jenkinsadm', description: "Jenkins credential that provides the AWS access key and secret.")
    ...
    string(name: 'key_pair', defaultValue : 'demosfdkey', description: "EC2 instance ssh keypair.")
  }
